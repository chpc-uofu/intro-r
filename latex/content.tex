...
The lectures require the access to an \texttt{R} language interpreter and the \texttt{RStudio} IDE.\newline
...
\item You can sign up for an account on \href{https://posit.cloud/}{\texttt{Posit\,Cloud}}, 
	which provides $25$ hours/month of free computing time.\newline
      \texttt{Posit\,Cloud} includes \texttt{R} and \texttt{RStudio}. 

\item You can also install \texttt{R} and \texttt{RStudio} on your machine. The \texttt{R} command-line 
	interpreter can be downloaded from the \href{https://cran.r-project.org/}{Comprehensive R Archive Network (CRAN)}.
...
All the course material can be obtained from: \href{https://github.com/chpc-uofu/intro-r}{https://github.com/chpc-uofu/intro-r}.
...
\href{https://github.com/chpc-uofu/intro-r/archive/refs/heads/main.zip}{https://github.com/chpc-uofu/intro-r/archive/refs/heads/main.zip}.
